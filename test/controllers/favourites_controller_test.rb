...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { feed: @favourite.feed, user_id_id: @favourite.user_id_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { feed: @favourite.feed, user_id_id: @favourite.user_id_id } }
